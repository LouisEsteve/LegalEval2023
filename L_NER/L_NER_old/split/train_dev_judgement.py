...
print(f"DATE\t{y_test.value_counts()['DATE']}")
print(f"ORG\t{y_test.value_counts()['ORG']}")
print(f"GPE\t{y_test.value_counts()['GPE']}")
print(f"STATUTE\t{y_test.value_counts()['STATUTE']}")
print(f"PROVISION\t{y_test.value_counts()['PROVISION']}")
print(f"PROVISION\t{y_test.value_counts()['PROVISION']}")
print(f"PRECEDENT\t{y_test.value_counts()['PRECEDENT']}")
print(f"CASE_NUMBER\t{y_test.value_counts()['CASE_NUMBER']}")
print(f"WITNESS\t{y_test.value_counts()['WITNESS']}")
print(f"OTHER_PERSON\t{y_test.value_counts()['OTHER_PERSON']}")
